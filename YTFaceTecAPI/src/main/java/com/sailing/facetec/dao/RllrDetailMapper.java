...
public interface RllrDetailMapper {
    ...
    String countSql = "select  count(*) from B_TZ_RLLR where LRRKSJ>=to_date('${beginTime}','yyyy-mm-dd hh24:mi:ss') and  LRRKSJ<=to_date('${endTime}','yyyy-mm-dd hh24:mi:ss') ${customerFilter}";
